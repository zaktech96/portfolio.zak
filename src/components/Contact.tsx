const Contact = () => {
  return (
    <section id="contact" className="py-24 sm:py-32 relative">
      ...
      <div className="absolute inset-0 -z-10 overflow-hidden">
        ...
        <div className="absolute left-1/2 top-1/3 h-80 w-[min(760px,90vw)] -translate-x-1/2 rounded-full bg-primary/[0.055] blur-3xl" />
      </div>
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-14">
          ...
          <p className="mx-auto mt-4 max-w-2xl text-lg leading-8 text-foreground/60">
            Ready to collaborate or discuss opportunities? Reach out through either channel.
          </p>
        </div>
  ...
  className="group rounded-2xl border border-border/70 bg-card/55 p-6 shadow-sm backdrop-blur transition-all duration-300 hover:-translate-y-1 hover:border-primary/25 hover:shadow-[0_24px_70px_hsl(var(--primary)/0.10)]"
>
